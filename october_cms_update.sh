...
#----------------------------------------
$PHP_PATH -q /MODIFY-TO-YOUR-WEBSITE1-PATH/$PHP_UPDATE
$PHP_PATH -q /MODIFY-TO-YOUR-WEBSITE2-PATH/$PHP_UPDATE
$PHP_PATH -q /MODIFY-TO-YOUR-WEBSITE3-PATH/$PHP_UPDATE
exit
